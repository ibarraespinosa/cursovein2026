...
Este script basicamente e o similar oa otro config, preparando os dados de entrada do modelo e plotando os dados.
...
O arquivo tem a informacao embaixo. A estrutura esta disenhadam de forma de identificar o ano do inventario do nome da pasta.
...
Aqui e adicionado a unidade km
...
Aqui e conferido que a frota vai ser do ano e mais velhos.
...
Esta e a frota inicial antes de ser calibrada e corrigida.

PC
![PC](content/figs/FLEET_PC_td.png)
LCV
![LCV](content/figs/FLEET_LCV.png)
TRUCKS
![TRUCKS](content/figs/FLEET_TRUCKS.png)
BUS
![BUS](content/figs/FLEET_BUS.png)
MC
![MC](content/figs/FLEET_MC.png)
...
![Temperature](content/figs/Temperature_td.png)
...
```
========================================
Brazil by state 2018
========================================

Directory: /media/sergio/ext5/usp2025/brazil_td/estimation/2018

Local Time: 2026-03-16 14:54:52.504644
...
[1] eixport_0.6.3       units_1.0-0         data.table_1.18.2.1
[4] ggplot2_4.0.0       cptcity_1.1.1       sf_1.1-0
[7] vein_1.7.0

loaded via a namespace (and not attached):
 [1] gtable_0.3.6       dplyr_1.1.4        compiler_4.3.3     tidyselect_1.2.1
 [5] Rcpp_1.1.1         parallel_4.3.3     scales_1.4.0       readxl_1.4.5
 [9] lattice_0.22-5     R6_2.6.1           labeling_0.4.3     generics_0.1.4
[13] classInt_0.4-11    dotCall64_1.2      tibble_3.3.0       DBI_1.3.0
[17] pillar_1.11.1      RColorBrewer_1.1-3 rlang_1.1.7        sp_2.2-1
[21] terra_1.9-1        S7_0.2.0           cli_3.6.5          withr_3.0.2
[25] magrittr_2.0.4     class_7.3-22       grid_4.3.3         ncdf4_1.24
[29] lifecycle_1.0.5    vctrs_0.6.5        KernSmooth_2.23-22 proxy_0.4-29
[33] glue_1.8.0         cellranger_1.1.0   raster_3.6-32      farver_2.1.2
[37] codetools_0.2-19   e1071_1.7-17       tools_4.3.3        pkgconfig_2.0.3
