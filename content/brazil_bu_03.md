...
Agora vamos apagar dados previos de trafego.
...
Se a variável survival for TRUE, então vamos aplicar a função age para calcular a idade dos veiculos.
Aqui sao lidas as informações de sobrevivencia dos veiculos que estao no arquivo metadata.
...
Primeiro vamos processar os veiculos de passageiros. Aqui o trafego e multiplicado pela proporcao da frota. Tambem e consdierado o fator initial de consumo de combustivel. O mesmo processo e aplicado para todos os tipos de veiculos.
