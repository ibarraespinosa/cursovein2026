...
Aqui vamos a especiar as emissoes.
...
Vamos usar estas funcoes:

- [wrf_get](https://atmoschem.github.io/eixport/reference/wrf_get.html) para obter as variaveis do WRF Chem.
- [eixport::wrf_create](https://atmoschem.github.io/eixport/reference/wrf_create.html)
- [emis_order](https://atmoschem.github.io/vein/reference/emis_order.html) Ordenacao das emissoes para o WRF.
- [GriddedEmissionsArray](https://atmoschem.github.io/vein/reference/GriddedEmissionsArray.html) para organizar o array de emissoes.
- [wrf_put](https://atmoschem.github.io/eixport/reference/wrf_put.html) para adicionar as emissoes ao WRF Chem.
...
![WRF_CO0](content/figs/WRF_CO0.png)
